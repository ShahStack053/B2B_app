...
const RFQsWidgetCard = ({ count, name, percentage, previousMonthName }) => {
  return (
    <div>
      <Card className="widget-rfqs-card">
        ...
        <div>
          <span className="widget-card-title">{name}</span>
